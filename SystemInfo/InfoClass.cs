...
namespace SystemInfoTrayApp
{
    ...
    class InfoClass
    {
        ...
        //---------------------------------------------------------------------------------------------------
        // return the bios serial number from powershell
        ...
        {deviceType
            ...
            else if (deviceType.Equals("wireless"))
            {
                myIP = getWirelessIP();
            } // end else if
